		...
		return (
			<View style={{ flex: 1 }}>
				...
				<ScrollView style={{ flex: 1 }}>
					...
					/>
					<Button
						title="Wrapped Setting"
						// description="Go to Settings Page"
						onPress={() => this.props.navigation.navigate('WrappedSettings')}
					/>
					<Button
						title="Setting (path)"
						// description="Go to Settings Page"
						onPress={() => this.props.navigation.push('SettingsTabs')}
					/>
					<Button title="Tabs" onPress={() => this.props.navigation.navigate('SettingsTabs')} />
					<Button
						title="Bottom Tabs"
						onPress={() => this.props.navigation.navigate('SettingsBottomTabs')}
					/>
					<Button title="Drawer" onPress={() => this.props.navigation.navigate('SettingsDrawer')} />
					<Button
